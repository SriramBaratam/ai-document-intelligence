...
def generate_quiz(
    ...
    prompt = f"""
You are a quiz engine inside a document intelligence application.
Create exactly {num_questions} multiple-choice questions from ONLY the document context below.
